...
//        randomBackground();
        ...
        userNameTextView.setText(question.getAnsweredBy());
    }
    ...
    public void onClick(View view) {
        if (view.getId() == R.id.award_button) {
            ...
            String mrks = percentageEditText.getText().toString().trim();
...
//            logo.setImageDrawable(Constants.getDrawableFromString(_context, childText.getLogoName()));
    ...
    private void initView(View rootView) {
        ...
        percentageEditText = (EditText) rootView.findViewById(R.id.percentage_edit_text);
